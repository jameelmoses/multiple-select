  ...
  */
  ...
  var MultipleSelect = /*#__PURE__*/function () {
    function MultipleSelect($el, options) {
      ...
      this.$el = $el;
      this.options = $__default['default'].extend({}, Constants.DEFAULTS, options);
    }
    ...
    _createClass(MultipleSelect, [{
      ...
      value: function initLocale() {
        if (this.options.locale) {
          var locales = $__default['default'].fn.multipleSelect.locales;
      ...
      value: function initContainer() {
        ...
        if (!this.$label.length && this.$el.attr('id')) {
          this.$label = $__default['default']("label[for=\"".concat(this.$el.attr('id'), "\"]"));
        }
        ...
        this.$parent = $__default['default']("\n      <div class=\"ms-parent ".concat(el.getAttribute('class') || '', "\"\n      title=\"").concat(el.getAttribute('title') || '', "\" aria-hidden=\"true\" />\n    ")); // add placeholder to choice button
        ...
        this.$choice = $__default['default']("\n      <button type=\"button\" class=\"ms-choice\"".concat(tabIndex, ">\n      <span class=\"placeholder\">").concat(this.options.placeholder, "</span>\n      ").concat(this.options.showClear ? '<div class="icon-close"></div>' : '', "\n      <div class=\"icon-caret\"></div>\n      </button>\n    ")); // default position is bottom

        this.$drop = $__default['default']("<div class=\"ms-drop ".concat(this.options.position, "\" />"));
        ...
        if (!this.options.keepOpen) {
          ...
          $__default['default'](document).off(clickEvent).on(clickEvent, function (e) {
            if ($__default['default'](e.target)[0] === _this.$choice[0] || $__default['default'](e.target).parents('.ms-choice')[0] === _this.$choice[0]) {
              return;
            }

            if (($__default['default'](e.target)[0] === _this.$drop[0] || $__default['default'](e.target).parents('.ms-drop')[0] !== _this.$drop[0] && e.target !== el) && _this.options.isOpen) {
              _this.close();
            }
          });
        }
      ...
      value: function initData() {
        ...
        if (this.options.data) {
          ...
          $__default['default'].each(this.$el.children(), function (i, elm) {
      ...
      value: function initRow(i, elm, groupDisabled) {
        ...
        if ($elm.is('optgroup')) {
          ...
          $__default['default'].each($elm.children(), function (j, elem) {
      ...
      value: function events() {
        ...
        var toggleOpen = function toggleOpen(e) {
          ...
          if ($__default['default'](e.target).hasClass('icon-close')) {
            return;
          }
        ...
        this.$selectAll.off('click').on('click', function (e) {
          _this8._checkAll($__default['default'](e.currentTarget).prop('checked'));
        });
      ...
      value: function open() {
        ...
        if (this.options.container) {
          ...
          this.$drop.appendTo($__default['default'](this.options.container));
          this.$drop.offset({
            top: offset.top,
            left: offset.left
        ...
        var _setSelects = function _setSelects(rows) {
          ...
          try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
              ...
              if (type === 'text') {
                selected = values.includes($__default['default'](row.text).text().trim());
              } else {
      ...
      value: function filter(ignoreTrigger) {
        var originalText = $__default['default'].trim(this.$searchInput.val());
  ...
  $__default['default'].fn.multipleSelect = function (option) {
    ...
    this.each(function (i, el) {
      ...
      var options = $__default['default'].extend({}, $this.data(), _typeof(option) === 'object' && option);
      ...
      if (typeof option === 'string') {
        ...
        if ($__default['default'].inArray(option, Constants.METHODS) < 0) {
  ...
  $__default['default'].fn.multipleSelect.defaults = Constants.DEFAULTS;
  $__default['default'].fn.multipleSelect.locales = Constants.LOCALES;
  $__default['default'].fn.multipleSelect.methods = Constants.METHODS;
