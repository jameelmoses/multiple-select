...
var script = {
  ...
  methods: _objectSpread2(_objectSpread2({
    ...
    _initDefaultValue: function _initDefaultValue() {
      ...
      this.$nextTick(function () {
        _this4.setSelects(Array.isArray(_this4.currentValue) ? _this4.currentValue : [_this4.currentValue], null, true);
      });
    }
  }, function () {
    var res = {};

    var _iterator = _createForOfIteratorHelper($.fn.multipleSelect.methods),
        _step;
